...
public class AddNode extends BinaryExpressionNode {
  ...
  public AddNode(ExpressionNode leftNode, ExpressionNode rightNode){
  ...
  public Value evaluateExpression(ScriptState scriptState) throws AgentServerException {
    ...
    return add(leftValueNode, rightValueNode);
  }
  
  public static Value add(Value leftValueNode, Value rightValueNode){
