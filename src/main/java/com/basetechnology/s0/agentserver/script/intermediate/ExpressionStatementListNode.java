...
public class ExpressionStatementListNode extends StatementNode {
  public List<StatementNode> expressionStatements;

  public ExpressionStatementListNode(List<StatementNode> expressionStatements){
  ...
  public void run(ScriptState scriptState) throws AgentServerException {
    ...
    for (StatementNode expressionStatementNode: expressionStatements)
      expressionStatementNode.run(scriptState);
  }
}
